...
export var HomeOutline = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var attrs = {
    "fill": "currentColor",
  ...
  return /*#__PURE__*/React.createElement(EmotionIconBase, _extends({
    ...
    d: "M22.262 10.468c-3.39-2.854-9.546-8.171-9.607-8.225L12 1.68l-.652.563c-.062.053-6.221 5.368-9.66 8.248A2.042 2.042 0 001 12a2 2 0 002 2h1v6a2 2 0 002 2h12a2 2 0 002-2v-6h1a2 2 0 002-2c0-.598-.275-1.161-.738-1.532zM14 20h-4v-5h4v5zm4-8l.002 8H15v-6H9v6H6v-8H2.999C5.764 9.688 10.314 5.773 12 4.32c1.686 1.453 6.234 5.367 9 7.681L18 12z"
  }));
});
HomeOutline.displayName = 'HomeOutline';
export var HomeOutlineDimensions = {
  height: 24,
  width: 24
};